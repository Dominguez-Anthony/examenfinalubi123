package com.example.examenfinalubi.adaptarores;
...
import com.example.examenfinalubi.actividades.ActividadArticulo;
...
public class VolumenAdaptador extends RecyclerView.Adapter<VolumenAdaptador.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_vol, parent, false);
